...
subLanguage:"xquery"},"self"]}]})})());hljs.registerLanguage("delphi",(()=>{"use strict";return e=>{
...
begin:"&[0-7]+"},{begin:"%[01]+"}]},s,c,t].concat(a)}}})());hljs.registerLanguage("python",(()=>{"use strict";function e(e){
...
end:"\\][\\.']*",relevance:0,contains:n},e.COMMENT("//","$")].concat(n)}}})());hljs.registerLanguage("xml",(()=>{"use strict";function e(e){
...
className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("arcade",(()=>{"use strict";return e=>{
...
}],illegal:/\[|%/},{begin:/\$[(.]/}],illegal:/#(?!!)/}}})());hljs.registerLanguage("abnf",(()=>{"use strict";function e(...e){
...
match:/%[si](?=".*")/},t.QUOTE_STRING_MODE,t.NUMBER_MODE]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}})());hljs.registerLanguage("ocaml",(()=>{"use strict";return e=>({name:"OCaml",
...
relevance:0},{begin:/->/}]})})());hljs.registerLanguage("vbscript",(()=>{"use strict";function e(e){
...
relevance:0}),e.C_NUMBER_MODE]}}})());hljs.registerLanguage("http",(()=>{"use strict";function e(...e){
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:c}}})());hljs.registerLanguage("gradle",(()=>{"use strict";return e=>({name:"Gradle",
case_insensitive:!0,
...
excludeBegin:!0,end:a+":",relevance:0}],illegal:/#|<\//};var l}})());hljs.registerLanguage("nginx",(()=>{"use strict";function e(e){
...
illegal:"[^\\s\\}\\{]"}}})());hljs.registerLanguage("vim",(()=>{"use strict";return e=>({name:"Vim Script",
keywords:{$pattern:/[!#@\w]+/,
...
end:"\\)"}]},{className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("diff",(()=>{"use strict";function e(...e){
return"("+((e=>{const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
...
keyword:"Self",built_in:i}},{className:"punctuation",begin:"->"},n]}}})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
...
}],a.contains=n.contains,n}})());hljs.registerLanguage("perl",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
contains:p}}})());hljs.registerLanguage("bnf",(()=>{"use strict";return e=>({
...
contains:[c]}]}}})());hljs.registerLanguage("clojure",(()=>{"use strict";return e=>{
...
illegal:/\S/,contains:[f,i,m,p,c,u,l,o,d]}}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
...
},{className:"class",begin:/\w+::\w+/},e.NUMBER_MODE]}}})());hljs.registerLanguage("autoit",(()=>{"use strict";return e=>{const t={
...
className:"params",begin:"\\(",end:"\\)",contains:[r,i,n]}]}]}}})());hljs.registerLanguage("css",(()=>{"use strict"
...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("erlang",(()=>{"use strict";return e=>{
...
},contains:[u]},s,e.QUOTE_STRING_MODE,b,o,l,d,{begin:/\.$/}]}}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(e){
return n("(?=",e,")")}function n(...e){return e.map((e=>{
return(n=e)?"string"==typeof n?n:n.source:null;var n})).join("")}return a=>{
const i="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",s={
...
contains:[l,e.SHEBANG(),s,b,g,o,v,m,c]}}})());hljs.registerLanguage("haml",(()=>{"use strict";return e=>({name:"HAML",
...
subLanguage:"ruby",excludeBegin:!0,excludeEnd:!0}]})})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
...
strings:i,keywords:u}}}})());hljs.registerLanguage("haskell",(()=>{"use strict";return e=>{const n={
...
}),n,{begin:"->|<-"}]}}})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("wasm",(()=>{"use strict";return e=>{
...
skip:!0})]}]})})());hljs.registerLanguage("tcl",(()=>{"use strict";function e(...e){
...
variants:[a.inherit(a.QUOTE_STRING_MODE,{illegal:null})]},r]};var n}})());hljs.registerLanguage("javascript",(()=>{"use strict"
...
className:"variable.constant"},R,k,{match:/\$[(.]/}]}}})());hljs.registerLanguage("dos",(()=>{"use strict";return e=>{
...
className:"number",begin:"\\b\\d+",relevance:0},t]}}})());hljs.registerLanguage("handlebars",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
className:"template-variable",begin:/\{\{/,end:/\}\}/,contains:[w]}]}}})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return"("+((e=>{
const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
})(e).capture?"":"?:")+e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null
;var n})).join("|")+")"}return n=>{
...
contains:[{begin:/\\./}]}]}}})());hljs.registerLanguage("gherkin",(()=>{"use strict";return e=>({name:"Gherkin",
aliases:["feature"],
...
className:"string",begin:'"""',end:'"""'},e.QUOTE_STRING_MODE]})})());hljs.registerLanguage("ini",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
starts:{end:/$/,contains:[t,l,r,i,c,a]}}]}}})());hljs.registerLanguage("arduino",(()=>{"use strict";function e(e){
return t("(?:",e,")?")}function t(...e){return e.map((e=>{
...
a._hints=n._hints,i.name="Arduino",i.aliases=["ino"],i.supersetOf="cpp",i}})());hljs.registerLanguage("powershell",(()=>{"use strict";return e=>{const n={
$pattern:/-?[A-z\.\-]+\b/,
...
begin:"\\\\\\n"}]}}},{className:"attr",begin:n+t+"$"}]}}})());hljs.registerLanguage("smalltalk",(()=>{"use strict";return e=>{
...
end:"\\)",contains:[e.APOS_STRING_MODE,a,e.C_NUMBER_MODE,s]}]}}})());hljs.registerLanguage("objectivec",(()=>{"use strict";return e=>{
...
begin:"@[A-Za-z]+"}]}}})());hljs.registerLanguage("json",(()=>{"use strict";return e=>({name:"JSON",
...
begin:"\\."+n.IDENT_RE,relevance:0},a,t,i],illegal:/#/}}})());hljs.registerLanguage("dockerfile",(()=>{"use strict";return e=>({
name:"Dockerfile",aliases:["docker"],case_insensitive:!0,
keywords:["from","maintainer","expose","env","arg","user","onbuild","stopsignal"],
contains:[e.HASH_COMMENT_MODE,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE,{
beginKeywords:"run cmd entrypoint volume add copy workdir label healthcheck shell",
starts:{end:/[^\\]$/,subLanguage:"bash"}}],illegal:"</"})})());hljs.registerLanguage("vhdl",(()=>{"use strict";return e=>({name:"VHDL",
case_insensitive:!0,keywords:{
...
begin:"'[A-Za-z](_?[A-Za-z0-9])*",contains:[e.BACKSLASH_ESCAPE]}]})})());hljs.registerLanguage("dart",(()=>{"use strict";return e=>{const n={
...
},e.C_NUMBER_MODE,{className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}})());hljs.registerLanguage("puppet",(()=>{"use strict";return e=>{
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("matlab",(()=>{"use strict";return e=>{var a={relevance:0,
...
begin:'""'}],starts:a
},e.COMMENT("^\\s*%\\{\\s*$","^\\s*%\\}\\s*$"),e.COMMENT("%","$")]}}})());hljs.registerLanguage("fsharp",(()=>{"use strict";return e=>{const n={begin:"<",
...
}),e.C_NUMBER_MODE]}}})());hljs.registerLanguage("awk",(()=>{"use strict";return e=>({name:"Awk",keywords:{
...
},e.REGEXP_MODE,e.HASH_COMMENT_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("ada",(()=>{"use strict";return e=>{
...
},r]}}})());hljs.registerLanguage("protobuf",(()=>{"use strict";return e=>({
